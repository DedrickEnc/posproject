...
//        intent.setPackage("com.vfi.smartpos.deviceservice");
    ...
    private void getAllDeviceInstance(IDeviceService deviceService){
        ...
        try {
            ...
            this.iSmartCardReader = deviceService.getSmartCardReader(0);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }
    ...
    public ISmartCardReader getiSmartCardReader() {
        return iSmartCardReader;
    }

    public void setiSmartCardReader(ISmartCardReader iSmartCardReader) {
        this.iSmartCardReader = iSmartCardReader;
    }
